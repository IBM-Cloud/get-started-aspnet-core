...
The following steps are the general procedure to set up and deploy your app. See more detailed instructions in the [Getting started tutorial for ASP.NET Core](https://console.cloud.ibm.com/docs/runtimes/dotnet/getting-started.html#getting_started).
